...
const parse = __nccwpck_require__(5483);
const enoent = __nccwpck_require__(2562);
...
const resolveCommand = __nccwpck_require__(2499);
const escape = __nccwpck_require__(5283);
const readShebang = __nccwpck_require__(502);
...
const shebangCommand = __nccwpck_require__(5745);
...
const path = __nccwpck_require__(1017);
const which = __nccwpck_require__(5523);
const getPathKey = __nccwpck_require__(7402);
...
const crossSpawn = __nccwpck_require__(8966);
const stripFinalNewline = __nccwpck_require__(5053);
const npmRunPath = __nccwpck_require__(1071);
const onetime = __nccwpck_require__(4897);
const makeError = __nccwpck_require__(3969);
const normalizeStdio = __nccwpck_require__(2214);
const {spawnedKill, spawnedCancel, setupTimeout, validateTimeout, setExitHandler} = __nccwpck_require__(7578);
const {handleInput, getSpawnedResult, makeAllStream, validateInputSync} = __nccwpck_require__(5329);
const {mergePromise, getSpawnedPromise} = __nccwpck_require__(7815);
const {joinCommand, parseCommand, getEscapedCommand} = __nccwpck_require__(1748);
...
const {signalsByName} = __nccwpck_require__(411);
...
const onExit = __nccwpck_require__(8212);
...
const isStream = __nccwpck_require__(3228);
const getStream = __nccwpck_require__(5793);
const mergeStream = __nccwpck_require__(5517);
...
const bufferStream = __nccwpck_require__(8952);
...
var _signals=__nccwpck_require__(2848);
var _realtime=__nccwpck_require__(7660);
...
var _core=__nccwpck_require__(5715);
var _realtime=__nccwpck_require__(7660);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(2033)
} else {
  core = __nccwpck_require__(9692)
}
...
const path = __nccwpck_require__(1017);
const pathKey = __nccwpck_require__(7402);
...
const mimicFn = __nccwpck_require__(4590);
...
const shebangRegex = __nccwpck_require__(8886);
...
if (!processOk(process)) {
  ...
  var signals = __nccwpck_require__(6445)
...
const isexe = __nccwpck_require__(9486)
